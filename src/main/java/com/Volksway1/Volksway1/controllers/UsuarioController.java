package com.Volksway1.Volksway1.controllers;


import com.Volksway1.Volksway1.dtos.UsuarioDto;
...
import com.Volksway1.Volksway1.repositories.UsuarioRepository;
import com.Volksway1.Volksway1.services.FileUploadService;
...
public class UsuarioController {
    ...
    public ResponseEntity<Object> buscarUsuarioId(@PathVariable(value = "idUsuario") UUID id) {
        ...
        if (usuarioBuscado.isEmpty()) {
            return ResponseEntity.status(HttpStatus.NOT_FOUND).body("Usuario náo encontrado");
    ...
    public ResponseEntity<Object> cadastroUsuario(@ModelAttribute @Valid UsuarioDto dadosRecebidos) {
